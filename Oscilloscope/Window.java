...
class Window {
    ...
    void setup() {
        ...
        Box selectDataType = new Box(BoxLayout.X_AXIS);
        ButtonGroup buttonGroup = new ButtonGroup();
        JRadioButton selectLight = new JRadioButton("Light");
        JRadioButton selectTemperature = new JRadioButton("Temperature");
        JRadioButton selectHumidity = new JRadioButton("Humidity");

        buttonGroup.add(selectLight);
        buttonGroup.add(selectTemperature);
        buttonGroup.add(selectHumidity);
        selectLight.setSelected(true);   // default

        // Button layout
        selectDataType.add(makeLabel("Select Data Type:", JLabel.LEFT));
        selectDataType.add(Box.createRigidArea(new Dimension(20, 0)));
        selectDataType.add(selectLight);
        selectDataType.add(selectTemperature);
        selectDataType.add(selectHumidity);
        selectDataType.add(Box.createHorizontalGlue());
        // Add event
        ...
        // Add to window
        main.add(selectDataType, BorderLayout.NORTH);
